...
const about = {
  ...
  description: {
    en: "I'm fluent in both English and French with nine plus years of professional experience, driven by delivering tangible results. My passion lies in developing efficient and innovative solutions that address complex challenges. I am currently seeking a challenging role where I can leverage my technical expertise and collaborate effectively with a cross-functional team.",
    fr: "Je maîtrise l'anglais et le français avec plus de neuf ans d'expérience professionnelle, animé par la volonté de livrer des résultats concrets. Ma passion réside dans le développement de solutions efficaces et innovantes face aux défis complexes. Je recherche actuellement un poste stimulant où je pourrai mettre à profit mon expertise technique et collaborer efficacement au sein d'une équipe pluridisciplinaire.",
  },
  resume: {
